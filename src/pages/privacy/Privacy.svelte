...
<Layout>
  ...
  <p>
    At sidecars.dev, accessible from www.sidecars.dev, one of our main
    priorities is the privacy of our visitors. This Privacy Policy document
    contains types of information that is collected and recorded by sidecars.dev
    and how we use it.
  </p>
  ...
  <p>
    ...
    and/or collect in sidecars.dev. This policy is not applicable to any
  ...
  <p>
    sidecars.dev follows a standard procedure of using log files. These files
  ...
  <p>
    Like any other website, sidecars.dev uses "cookies". These cookies are used
  ...
  <p>
    sidecars.dev does not knowingly collect any Personal Identifiable
  ...
  <p>
    ...
    hesitate to contact us by email at sidecars@gaunt.dev.
  </p>
</Layout>
